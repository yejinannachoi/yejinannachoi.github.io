...
<div style="font-size:25px; font-family: 'Source Sans 3', sans-serif; font-weight: bold; margin-bottom: 10px;">Discussion</div>
<div style="font-size:16px; font-family: 'Source Sans 3', sans-serif; margin-bottom: 10px;">Although the current model has limited applicability due to its low accuracy and precision scores, the findings may serve as <strong>a valuable starting point</strong> for further analysis. The challenges in reliably predicting deal outcomes when considering features such as category, website, askedfor, exchangeforstake, valuation, multiple_entrepreneurs, city, and state together highlight <strong>the complexity of investment decisions</strong>.</div>
<div style="font-size:16px; font-family: 'Source Sans 3', sans-serif; margin-bottom: 10px;">This complexity suggests that <strong>additional, more nuanced features</strong> are needed to improve model performance. For instance, incorporating variables like market size, entrepreneur experience, or pitch quality could better capture the dynamics of successful negotiations. By broadening the dataset to include such factors, the model can be refined with enhanced predictive power.</div>
<div style="font-size:16px; font-family: 'Source Sans 3', sans-serif; margin-bottom: 10px;">The implications of these findings extend beyond improving prediction accuracy. For entrepreneurs, understanding the key elements influencing investment decisions can guide them in tailoring their pitches to meet investor expectations, increasing their chances of success. Investors, in turn, can use refined models to identify companies with higher potential for growth and profitability, leading to more informed and effective decision-making.</div>
<div style="font-size:16px; font-family: 'Source Sans 3', sans-serif; margin-bottom: 40px;">A robust model that reliably predicts deal outcomes would provide <strong>actionable insights for both entrepreneurs and investors</strong>. Entrepreneurs could better align their strategies with factors most valued by investors, while investors could uncover opportunities in emerging markets and industries, fostering innovation and driving economic growth. This ongoing refinement process bridges the gap between raw data and impactful decision-making, paving the way for <strong>a more data-driven entrepreneurial ecosystem</strong>.</div>

<!-- ------------------------------------------- Code ------------------------------------------- -->
<hr>

<div style="font-size:25px; font-family: 'Source Sans 3', sans-serif; font-weight: bold; margin-bottom: 10px;">Code</div>
<a href="codebook.html">View Codebook</a>
