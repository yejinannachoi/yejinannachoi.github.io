...
<div style="font-size:16px; font-family: 'Source Sans 3', sans-serif; margin-bottom: 10px;">The underlying theory of this project is that the various characteristics of red wine contribute to its overall quality. The focus is on predicting red wine quality based on a set of measurable factors.</div>
